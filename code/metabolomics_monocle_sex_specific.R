...
saveRDS(D1, file='data_objects/metsF_matrix_all.rds')
saveRDS(D1, file='data_objects/metsM_matrix_all.rds')
...
saveRDS(MonRun, file='data_objects/MonRunF_mets.RDS')
saveRDS(MonRun, file='data_objects/MonRunM_mets.RDS')
